...
% 文字サイズを大きくするための設定
\renewcommand{\normalsize}{\fontsize{16}{19}\selectfont}
\setlength{\parskip}{0.2em}
\setlength{\parindent}{0pt}

% リストの間隔を詰める
\setlist{nosep,leftmargin=*,itemsep=0.05em,topsep=0.1em,parsep=0.05em}
...
\begin{center}
\vspace{0.1cm}
{\Huge \textbf{Stability and Faithfulness Analysis of SHAP Explanations}}\\[0.1cm]
{\LARGE \textit{for Tabular Machine Learning Models}}\\[0.2cm]
{\Large Keisuke Nishioka (Matrikelnummer: 10081049)}\\[0.05cm]
{\normalsize Interpretierbares Maschinelles Lernen | Prof. Dr. rer. nat. Marius Lindauer}\\[0.1cm]
...
\normalsize How stable and faithful are SHAP explanations across different random seeds, dataset sizes, and model classes?
...
\textbf{\large Stability Metrics Comparison:}
...
\textbf{\large Dataset:}\\
\normalsize Wine Quality (UCI Repository)\\
...
\textbf{\large Experimental Setup:}
\begin{itemize}[leftmargin=*,itemsep=0.1em,topsep=0.1em]
...
\begin{center}
\includegraphics[width=0.98\textwidth]{results/figures/model_comparison.png}
\vspace{0.1em}

\normalsize\textit{Model Stability Comparison}
\end{center}

\vspace{0.2em}

\begin{center}
\includegraphics[width=0.32\textwidth]{results/figures/random_forest_shap_summary.png}
\includegraphics[width=0.32\textwidth]{results/figures/xgboost_shap_summary.png}
\includegraphics[width=0.32\textwidth]{results/figures/logistic_regression_shap_summary.png}
\vspace{0.1em}

\normalsize\textit{SHAP Summary: RF, XGBoost, Logistic Regression}
\end{center}
...
\begin{center}
\includegraphics[width=0.45\textwidth]{results/figures/random_forest_consistency.png}
\includegraphics[width=0.45\textwidth]{results/figures/xgboost_consistency.png}
\vspace{0.1em}

\normalsize\textit{Consistency: RF (left), XGBoost (right)}
\end{center}

\vspace{0.1em}

\textbf{\large Model Insights:}
\begin{itemize}
...
\begin{center}
\includegraphics[width=0.98\textwidth]{results/figures/subsampling_analysis.png}
\vspace{0.1em}

\normalsize\textit{Stability vs. Sample Size}
\end{center}

\vspace{0.2em}

\textbf{\large Ranking Correlation by Sample Size:}
\begin{center}
\small
\begin{tabular}{lccc}
\toprule
...
% Footer
\begin{center}
\rule{0.95\textwidth}{0.5pt}\\[0.15cm]
{\normalsize \textit{Interpretierbares Maschinelles Lernen (WiSe 2025/26) | Keisuke Nishioka (Matrikelnummer: 10081049)}}\\[0.05cm]
{\small \textit{Code: \url{https://github.com/keisuke58/shap-stability-analysis}}}
\end{center}
